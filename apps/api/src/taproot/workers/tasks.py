...
# A runner takes the investigation and performs the work. Sprint 3 injects the
# LangGraph agent; the default is a no-op stub.
Runner = Callable[[Investigation], Awaitable[None]]


async def _stub_runner(_investigation: Investigation) -> None:
    return None
...
async def execute_investigation(
    ...
    *,
    ...
    try:
        await (runner or _stub_runner)(inv)
